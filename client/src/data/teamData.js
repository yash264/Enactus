...
export const teamData = {
  web: {
    ...
    alumni: [
      {
        name: "Gawtham Vellore",
        year: "2019",
        email: "contact@enactus.com",
        linkedin: "https://www.linkedin.com/in/gawtham-vellore",
        image: GawthamVellore,
        position: "Alumni"
      },
      {
        name: "Adya Sharma",
        year: "2021",
        email: "contact@enactus.com",
        linkedin: "https://www.linkedin.com/in/adya-sharma",
        image: AdyaSharma,
        position: "Alumni"
      },
      {
        ...
        year: "2009",
        email: "contact@enactus.com",
        linkedin: "https://www.linkedin.com/in/himanshu-tripathi",
        image: HimanshuTripathi,
        position: "Alumni"
      },
      {
        name: "Shruti Mayank",
        year: "2022",
        email: "contact@enactus.com",
        linkedin: "https://www.linkedin.com/in/shruti-mayank",
        image: ShrutiMayank,
        position: "Alumni"
      }
    ]
    ...
    alumni: [
      {
        ...
        year: "2021",
        email: "contact@enactus.com",
        linkedin: "https://www.linkedin.com/in/shaurya-raj-srivastava",
        image: ShauryaRajSrivastava,
        position: "Alumni"
      },
      {
        name: "Aniket Shah",
        year: "2020",
        email: "contact@enactus.com",
        linkedin: "https://www.linkedin.com/in/aniket-shah",
        image: AniketShah,
        position: "Alumni"
      }
    ]
...
// Team configuration with metadata
...
// Helper function to get team data by key
export const getTeamData = (teamKey) => {
  return teamConfig[teamKey]?.data || { present: [], alumni: [] };
};

// Helper function to get team metadata
export const getTeamMetadata = (teamKey) => {
  const team = teamConfig[teamKey];
  return {
    name: team?.name || "Unknown Team",
    description: team?.description || "Team description not available",
    path: team?.path || "/"
  };
};

// Export individual team data for direct access
export const webTeamData = teamData.web;
export const researchTeamData = teamData.research;
export const contentTeamData = teamData.content;
export const fieldTeamData = teamData.field;
export const designTeamData = teamData.design;
export const marketingTeamData = teamData.marketing;
