export default function Stats() {
    return (
      <section className="stats_box py-10 grid bg-enactusYellow rounded-[40px] place-items-center lg:grid-cols-4 grid-cols-2 gap-4 sm:w-9/12 w-11/12 mx-auto -mt-8 px-4">
        <div>
